...
INSERT INTO hotels (name, town_id, type, price, rating, about, amenities, image) VALUES ('Costa Villa Beach Resort', 1, 'Beach Resort', 2800, 4, 'A relaxed beachfront resort in San Juan with cozy rooms, a pool, and an easy walk to the surf and cafes.', 'Pool, Beachfront, Restaurant, Free WiFi', 'hotel/villa.webp');
...
INSERT INTO hotels (name, town_id, type, price, rating, about, amenities, image) VALUES ('Hotel Ariana', 2, 'Hotel', 2400, 4.2, 'A comfortable mid-range city hotel near the heart of San Fernando, good for business and family stays.', 'Free WiFi, Restaurant, Function Hall, Parking', 'hotel/hotelariana.jpg');
...
INSERT INTO hotels (name, town_id, type, price, rating, about, amenities, image) VALUES ('Travelite Hotel', 1, 'Inn', 1500, 3.9, 'A budget-friendly inn in San Juan, a short ride from the beach, popular with surfers and backpackers.', 'Free WiFi, Breakfast, Parking', 'hotel/travellite.webp');
INSERT INTO hotels (name, town_id, type, price, rating, about, amenities, image) VALUES ('Hoyrl Hotel', 1, 'Hotel', 1800, 3.9, 'A simple, no-frills hotel in San Juan with clean rooms close to the surf town''s cafes and beach.', 'Free WiFi, Parking, Restaurant', 'hotel/hoyrl.jpg');
